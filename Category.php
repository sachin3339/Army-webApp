          ...
          <div class="row">
            <div class="col-lg-6">
              <div class="wow fadeInDown" data-wow-offset="0" data-wow-delay="0.1s">
                <h2 class="h-ultra">Ammunation category </h2>
              </div>
                        ...
                        <div class="row">
                          <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="form-group">
                              <label> Name of Ammunation</label>
                          ...
                          <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="form-group">
                              <label>Category of Ammunation</label>
            ...
            <div class="wow fadeInUp" data-wow-delay="0.2s">
              <div class="box text-center">
                ...
                <i class="fa fa-check fa-3x circled bg-skin"></i>
                  <h4 class="h-bold"><a href="Inventory.php">INVENTORY</a></h4>
                <p>
            ...
            <div class="wow fadeInUp" data-wow-delay="0.2s">
              <div class="box text-center">
                ...
                <i class="fa fa-list-alt fa-3x circled bg-skin"></i>
                  <h4 class="h-bold"><a href="Squad.php">SQUAD REGISTRATION</a></h4>
                <p>
                  Lorem ipsum dolor sit amet, nec te mollis utroque honestatis, ut utamur molestiae vix, graecis eligendi ne.
                </p>
              </div>
          ...
          <div class="col-sm-3 col-md-3">
            <div class="wow fadeInUp" data-wow-delay="0.2s">
              <div class="box text-center">
                ...
                <h4 class="h-bold"><a href="Status.php">MARTYR STATUS</a></h4>
                <p>
                  Lorem ipsum dolor sit amet, nec te mollis utroque honestatis, ut utamur molestiae vix, graecis eligendi ne.
                </p>
              </div>
