...
$y1=$_POST['y1'];
	...
	global $conn;
	$query="SELECT manufaturingdate, manufacturinglocation, orgname,name_ FROM manufacturingdetails as m ,soldier as s,inventory as i where m.serial_no=i.serial_no and i.id=s.id and s.name_='Balvir Singh';
  ";
